...
public class CrapsGUIV3 extends JFrame {
    ...
    private JLabel nullText, dice1L, dice2L, dice1L2, dice2L2, sumL, pointL, statusL;
        ...
        public void actionPerformed(ActionEvent e) {
            int dice1, dice2;
                if (firstRoll == true) {
                    ...
                    switch (dice1) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            dice1L2 = new JLabel(diceIcon5);
                            break;
                        case 6:
                            dice1L2 = new JLabel(diceIcon6);
                            break;
                        default:
                            dice1L2 = new JLabel(diceIcon1);
                    }
                    ...
                    switch (dice2) {
                        case 2: 
                            dice2L2 = new JLabel(diceIcon2);
                            break;
                        case 3:
                            dice2L2 = new JLabel(diceIcon3);
                            break;
                        case 4:
                            dice2L2 = new JLabel(diceIcon4);
                            break;
                        case 5:
                            dice2L2 = new JLabel(diceIcon5);
                            break;
                        case 6:
                            dice2L2 = new JLabel(diceIcon6);
                            break;
                        default:
                            dice2L2 = new JLabel(diceIcon1);
                    }
                ...
                if (firstRoll == false) {
                    ...
                    switch (dice1) {
                        case 2: 
                            dice1L2 = new JLabel(diceIcon2);
                            dice1L2.revalidate();
                            dice1L2.repaint();
                            break;
                        case 3:
                            dice1L2 = new JLabel(diceIcon3);
                            break;
                        case 4:
                            dice1L2 = new JLabel(diceIcon4);
                            break;
                        case 5:
                            dice1L2 = new JLabel(diceIcon5);
                            break;
