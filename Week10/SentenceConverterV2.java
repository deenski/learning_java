import java.util.*;
public class SentenceConverterV2 {
   public static void main(String[] args) {
      ...
      do{
        ...
        begins with a vowel, a common prefix, or neither. */
         ...
         //get all of the words and convert it to lower case.
         ...
         while (str.hasMoreTokens()) {
             ...
             if (beginsWithVowel(str.nextToken())) {
                x = 1;
             }
             
             //figure out if the word starts with a common prefix
             else if (beginsWithPrefix(str.nextToken())) {
                x = 2; 
             }
             ...
             //StringTokenizer word = new StringTokenizer(userInput);
             if (str.hasMoreTokens()){
                word.append(str.nextToken());
